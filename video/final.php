...
<div id='txtHint3' style='display:none'>0</div>
 <div id='progress-wrap'>
  ...
  <progress  value='1' max='100' class='progress' style='width: 250px; height: 25px;'></progress>
</div>
<div id='progress-wrap1' style='display:none;'>
     <div class='progress-message1'>Please wait ..your files are uploading </div>  
  <progress  value='1' max='100' class='progress1' style='width: 250px; height: 25px;'></progress>
</div>
...
<div id="form">
 <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" >
  ...
  <tr>
   ...
   <tr>
     <td align="right"><p id="filenameHint">.</p></td>
   </tr>
   <tr>
     <td align="left"><span><p>File: .mov, .avi, .wma , .mpeg :</span></p> </td>
  ...
  <input type="radio" name="convert" value="0"> Donot Convert
    </td>
  </tr>
  <tr>

    <td> </td>
     <td><button name="Submit" value="Upload Video" id="myBtn">Upload Video</button></td>
     <td><button onclick="window.open('logout.php','_self')">Logout</button><td>
  </tr>
 </table>
